...
@section('title', 'Confirm Password - ' . config('app.name', 'Remenant Health'))
...
<div class="bg-[var(--bg-main)] flex flex-col lg:flex-row lg:h-[calc(100vh-100px)] lg:min-h-[600px]">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center p-12 text-center">
        <img src="{{ asset('images/products/remenant-product14.jpg') }}" alt="Security" class="absolute inset-0 h-full w-full object-cover">
        <div class="absolute inset-0 bg-black/40"></div>
        <div class="relative z-10">
            <h2 class="text-6xl font-black italic tracking-tighter text-white uppercase leading-none mb-6">Verify<br>Identity.</h2>
    ...
    <div class="flex-1 flex items-start justify-center p-6 lg:pt-32 relative">
        <div class="w-full max-w-[440px]">
            ...
            <div class="mb-10">
                <p class="text-[10px] font-black uppercase tracking-[0.25em] text-[color:var(--primary)] mb-3">Security Check</p>
                <h1 class="text-4xl font-black italic tracking-tighter text-[color:var(--text-primary)] uppercase leading-none mb-6">Confirm Password</h1>
            ...
            <form method="POST" action="{{ route('password.confirm') }}" class="space-y-6">
                ...
                <div class="pt-4">
                    <button type="submit" class="w-full rounded-2xl bg-[color:var(--text-primary)] py-5 text-xs font-black text-white uppercase tracking-[0.2em] shadow-2xl shadow-black/20 hover:brightness-110 active:scale-[0.98] transition-all flex items-center justify-center gap-3 group">
                        Confirm Access
                        <i data-lucide="lock" class="h-4 w-4 transition-transform group-hover:scale-110"></i>
                    </button>
                </div>
            </form>
        </div>
