...
@section('content')
                            ...
                            @foreach($galleryImages as $index => $img)
                                <div class="relative aspect-square overflow-hidden cursor-pointer bg-gray-100"
                                    ...
                                    <img src="{{ \App\Helpers\ImageHelper::getUrl($img, 'images/products') }}" 
                                         ...
                                         height="1200"
                                         alt="{{ $product->title }}" 
                                         class="h-full w-full object-cover select-none opacity-0 transition-opacity duration-500 relative z-10"
    ...
    <script>
        ...
        window.applyCoupon = function() {
            ...
            // Hide previous error
            $('#coupon-error').addClass('hidden').text('');
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    ...
                    $('#coupon-error').text(msg).removeClass('hidden');
                }
            });
        };
