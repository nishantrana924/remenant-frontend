    ...
    <div class="w-full flex flex-col md:flex-row min-h-screen pt-0">
        ...
        <div class="w-full md:w-[260px] bg-white border-r border-slate-200 shrink-0 min-h-[calc(100vh-80px)]">
            ...
            <div class="flex flex-col" id="dashboard-nav">
                <button onclick="switchTab('orders', this)" class="nav-link px-6 py-4 flex items-center gap-4 bg-orange-50 text-orange-600 border-r-4 border-orange-500 transition-all">
                ...
                <div class="border-b border-slate-50">
                    ...
                    <div class="pb-2">
                        <button onclick="switchTab('profile', this)" class="nav-link block w-full text-left px-14 py-2 text-[10px] font-bold text-slate-500 hover:text-orange-500 transition-all uppercase">Profile Information</button>
                        <button onclick="switchTab('addresses', this)" class="nav-link block w-full text-left px-14 py-2 text-[10px] font-bold text-slate-500 hover:text-orange-500 transition-all uppercase">My Addresses</button>
                    </div>
                </div>
                ...
                <div class="border-b border-slate-50">
                    ...
                    <div class="pb-2">
                        <button onclick="switchTab('giftcards', this)" class="nav-link block w-full text-left px-14 py-2 text-[10px] font-bold text-slate-500 hover:text-orange-500 transition-all uppercase">Gift Cards</button>
                        <button onclick="switchTab('payments', this)" class="nav-link block w-full text-left px-14 py-2 text-[10px] font-bold text-slate-500 hover:text-orange-500 transition-all uppercase">Saved UPI</button>
                    </div>
                </div>
        ...
        <div class="flex-1 bg-white min-h-[calc(100vh-80px)] relative overflow-hidden">
            ...
            <div id="section-profile" class="tab-section hidden p-4 sm:p-10 transition-all duration-300">
                ...
                <form method="post" action="{{ route('profile.update') }}" class="max-w-xl space-y-6">
                    ...
                    <div class="pt-4"><button type="submit" class="bg-slate-900 text-white px-10 py-3 text-[10px] font-black uppercase tracking-widest">Save Changes</button></div>
                </form>
            </div>
