...
@section('content')
    ...
    <section class="relative overflow-hidden bg-[var(--bg-sage)] py-20 lg:py-28 border-b border-black/5">
        <div class="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-12 relative z-10">
            <div class="text-center">
                <span
                    class="inline-block px-4 py-1.5 rounded-full bg-white/50 text-xs font-semibold uppercase tracking-[0.2em] text-[#074D3D] backdrop-blur-sm">Get
                    in Touch</span>
                ...
                <p class="mt-8 mx-auto max-w-2xl text-lg font-medium leading-relaxed text-[#074D3D]/80 sm:text-xl">
                    Have a question or just want to say hi? We're always here to listen and help you on your wellness
                    journey.
                </p>
            </div>
        </div>
        ...
        <div class="pointer-events-none absolute -right-12 bottom-10 text-6xl opacity-20 animate-float"
            style="animation-delay: 2s;">🍉</div>
        <div class="pointer-events-none absolute left-1/4 -top-10 text-5xl opacity-10 animate-float"
        ...
        <div class="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-12">
            <div class="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-start">
                ...
                <div class="lg:col-span-7">
                    <div
                        class="rounded-[3rem] bg-white p-10 sm:p-14 shadow-2xl shadow-gray-200/50 border border-black/[0.03] relative overflow-hidden">
                        <!-- Subtle corner accent -->
                        <div
                            class="absolute top-0 right-0 w-32 h-32 bg-[var(--bg-sage)] opacity-20 rounded-bl-[5rem] -mr-10 -mt-10">
                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select
                                            ...
                                            <option>Product Guidance & Consultation</option>
                                            <option>Returns & Refunds</option>
                                            <option>Wholesale & Bulk Inquiries</option>
                                            <option>Partnership Opportunities</option>
                                            <option>Career Inquiries</option>
                                            <option>Feedback & Suggestions</option>
                                        </select>
                                        <i data-lucide="chevron-down"
                                            class="absolute right-6 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400 pointer-events-none"></i>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="lg:col-span-5">
                    <div
                        class="rounded-[3rem] bg-white p-10 border border-black/[0.03] shadow-2xl shadow-gray-200/40 space-y-12">

                        <!-- Contact Item -->
                        <div class="flex gap-6">
                            <div
                                class="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-[var(--primary-soft)] text-[var(--primary)] shadow-sm shadow-orange-100">
                                <i data-lucide="map-pin" class="h-6 w-6"></i>
                            </div>
                            <div>
                                <h3 class="text-sm font-semibold uppercase tracking-widest text-gray-400 mb-2">Address</h3>
                        ...
                        <div class="flex gap-6">
                            <div
                                class="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-[#E8F9F1] text-[#25D366] shadow-sm shadow-green-100">
                                <i data-lucide="message-circle" class="h-6 w-6"></i>
                            </div>
                            <div>
                                <h3 class="text-sm font-semibold uppercase tracking-widest text-gray-400 mb-2">Instant Help
                                </h3>
                        ...
                        <div class="flex gap-6">
                            <div
                                class="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gray-100 text-gray-600 shadow-sm shadow-gray-200">
                        ...
                        <div class="flex gap-6">
                            <div
                                class="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-[#F0F4FF] text-[var(--info)] shadow-sm shadow-blue-100">
    ...
    <!-- Map Section -->
    <section class="pb-16 bg-[#FDF9F6]">
        <div class="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-12">
            <div
                class="relative h-[450px] w-full overflow-hidden rounded-[3rem] bg-gray-100 shadow-2xl border border-black/5">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6122.088102593285!2d72.88633732247716!3d21.241490584403888!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be04f5100c5afcd%3A0xf0c8c348ba866c82!2sAmbika%20Pinnacle!5e1!3m2!1sen!2sin!4v1777717567283!5m2!1sen!2sin"
                    width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy"
                    referrerpolicy="no-referrer-when-downgrade" class="grayscale-[20%] contrast-[1.1]">
                </iframe>
            </div>
        </div>
    </section>
