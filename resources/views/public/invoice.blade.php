...
<body class="text-slate-800 text-[11px]">
    ...
    <div class="no-print fixed top-6 right-6 flex gap-3 z-50">
        ...
        <a href="{{ route('order.track', $order->order_number) }}" class="bg-white text-slate-600 border border-slate-200 px-6 py-2 rounded-full font-bold shadow-sm hover:bg-slate-50 transition-all text-sm flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
